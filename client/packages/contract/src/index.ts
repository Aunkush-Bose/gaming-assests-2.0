...
export interface Client {
   ...
   */
  get_asset: ({player, asset_id}: {player: string, asset_id: string}, options?: MethodOptions) => Promise<AssembledTransaction<string>>
   ...
   */
  mint_asset: ({player, asset_id, metadata}: {player: string, asset_id: string, metadata: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
   ...
   */
  transfer_asset: ({from, to, asset_id}: {from: string, to: string, asset_id: string}, options?: MethodOptions) => Promise<AssembledTransaction<null>>
...
export class Client extends ContractClient {
  ...
  constructor(public readonly options: ContractClientOptions) {
    super(
      new ContractSpec([ "AAAAAAAAAAAAAAAJZ2V0X2Fzc2V0AAAAAAAAAgAAAAAAAAAGcGxheWVyAAAAAAATAAAAAAAAAAhhc3NldF9pZAAAABEAAAABAAAAEQ==",
        ...
        "AAAAAAAAAAAAAAAOdHJhbnNmZXJfYXNzZXQAAAAAAAMAAAAAAAAABGZyb20AAAATAAAAAAAAAAJ0bwAAAAAAEwAAAAAAAAAIYXNzZXRfaWQAAAARAAAAAA==" ]),
      options
    )
  }
  public readonly fromJSON = {
    get_asset: this.txFromJSON<string>,
        mint_asset: this.txFromJSON<null>,
